...
Com o servidor ativo, execute `npm install` e `npm test`. A verificação usa Playwright e Microsoft Edge, visita as 51 páginas em larguras de 1440 e 390 píxeis, procura imagens em falta, erros JavaScript e transbordo horizontal, e verifica os controlos dos carrosséis e do menu móvel. Guarda `verification-report.json` e duas capturas de ecrã.
